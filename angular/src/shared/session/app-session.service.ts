...
export class AppSessionService {
    ...
    constructor(
        ...
        private _studioxMultiTenancyService: StudioXMultiTenancyService) {
    }
    ...
    getShownLoginName(): string {
        ...
        if (!this._studioxMultiTenancyService.isEnabled) {
            return userName;
        }
    ...
    changeTenantIfNeeded(tenantId?: number): boolean {
        ...
        studiox.multiTenancy.setTenantIdCookie(tenantId);
        location.reload();
        return true;
    }
