...
@Injectable()
export class StudioXHttpConfiguration {
    ...
    handleNonStudioXErrorResponse(response: Response) {
        const self = this;
    ...
    getStudioXAjaxResponseOrNull(response: Response): IAjaxResponse | null {
...
@Injectable()
export class StudioXHttp extends Http {
    ...
    constructor(
        ...
        configuration: StudioXHttpConfiguration) {
    ...
    protected addAcceptLanguageHeader(options: RequestOptionsArgs) {
        let cookieLangValue = this._utilsService.getCookieValue("StudioX.Localization.CultureName");
    ...
    protected addTenantIdHeader(options: RequestOptionsArgs) {
        let cookieTenantIdValue = this._utilsService.getCookieValue('StudioX.TenantId');
        if (cookieTenantIdValue && options.headers && !options.headers.has('StudioX.TenantId')) {
