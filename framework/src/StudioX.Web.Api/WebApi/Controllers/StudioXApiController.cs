...
{
    /// <summary>
    /// Base class for all ApiControllers in web applications those use StudioX system.
    /// </summary>
    public abstract class StudioXApiController : ApiController
    {
        /// <summary>
        ...
        /// Constructor.
        /// </summary>
        protected StudioXApiController()
        {
