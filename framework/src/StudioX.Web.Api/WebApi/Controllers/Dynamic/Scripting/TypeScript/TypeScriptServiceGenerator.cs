    ...
    public class TypeScriptServiceGenerator : ITransientDependency
    {
        ...
        public string GetScript()
        {
            ...
            if (servicePrefix.IsNullOrEmpty())
                script.AppendLine("module studiox.services");//Create a new Module
            else
                script.AppendLine("module studiox.services." + servicePrefix);//Create a new Module
            script.AppendLine("{");
            ...
            script.AppendLine("}");
            #region Create Script for StudioX common objects

            script.AppendLine("declare module studiox {");
