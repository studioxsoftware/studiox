...
namespace StudioX.Domain.Uow
{
    ...
    public interface IActiveUnitOfWork
    {
        ...
        /// </summary>
        /// <param name="filterNames">One or more filter names. <see cref="StudioXDataFilters"/> for standard filters.</param>
        ...
        /// </summary>
        /// <param name="filterName">Name of the filter. <see cref="StudioXDataFilters"/> for standard filters.</param>
