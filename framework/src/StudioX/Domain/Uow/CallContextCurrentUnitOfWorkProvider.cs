...
namespace StudioX.Domain.Uow
{
    ...
    public class CallContextCurrentUnitOfWorkProvider : ICurrentUnitOfWorkProvider, ITransientDependency
    {
        ...
        private const string ContextKey = "StudioX.UnitOfWork.Current";
        ...
        private static void SetCurrentUow(IUnitOfWork value, ILogger logger)
        {
            ...
            {
                throw new StudioXException("Can not set unit of work! UnitOfWorkDictionary.TryAdd returns false!");
            }
