...
namespace StudioX.Configuration
{
    ...
    public interface ISettingManager
    {
        ...
        /// <summary>
        ///     Gets current value of a setting for the application level.
        ///     If fallbackToDefault is false, it just gets value from tenant and returns null if application has not defined a
        ...
        ///     If fallbackToDefault is false, it just gets value from tenant and returns null if tenant has not defined a value
        ///     for the setting.
        /// </summary>
        /// <param name="name">Unique name of the setting</param>
        /// <param name="tenantId">Tenant id</param>
        ...
        ///     If fallbackToDefault is false, it just gets value from user and returns null if user has not defined a value for
        ///     the setting.
        /// </summary>
        /// <param name="name">Unique name of the setting</param>
        /// <param name="tenantId">Tenant id</param>
        ...
        ///     It gets all setting values, overwritten by application, current tenant (if exists) and the current user (if
        ///     exists).
        /// </summary>
