...
namespace StudioX.Configuration.Startup
{
    ...
    public static class StudioXStartupConfigurationExtensions
    {
        ...
        public static void ReplaceService(this IStudioXStartupConfiguration configuration, Type type, Type impl, DependencyLifeStyle lifeStyle = DependencyLifeStyle.Singleton)
        {
        ...
        /// <param name="configuration">The configuration.</param>
        /// <param name="lifeStyle">Life style.</param>
        public static void ReplaceService<TType, TImpl>(this IStudioXStartupConfiguration configuration, DependencyLifeStyle lifeStyle = DependencyLifeStyle.Singleton)
            where TType : class
