...
namespace StudioX.Authorization
{
    ...
    public class StudioXAuthorizeAttribute : Attribute, IStudioXAuthorizeAttribute
    {
        /// <summary>
        ...
        /// <summary>
        ///     Creates a new instance of <see cref="StudioXAuthorizeAttribute" /> class.
        /// </summary>
        /// <param name="permissions">A list of permissions to authorize</param>
        public StudioXAuthorizeAttribute(params string[] permissions)
        {
