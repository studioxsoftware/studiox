        ...
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container.Register(
                ...
                Component.For<IEventBusConfiguration, EventBusConfiguration>().ImplementedBy<EventBusConfiguration>()
                    .LifestyleSingleton(),
                Component.For<IMultiTenancyConfig, MultiTenancyConfig>().ImplementedBy<MultiTenancyConfig>()
                    .LifestyleSingleton(),
                ...
                Component.For<IStudioXStartupConfiguration, StudioXStartupConfiguration>()
                    .ImplementedBy<StudioXStartupConfiguration>().LifestyleSingleton(),
                Component.For<ITypeFinder, TypeFinder>().ImplementedBy<TypeFinder>().LifestyleSingleton(),
                Component.For<IStudioXPlugInManager, StudioXPlugInManager>().ImplementedBy<StudioXPlugInManager>()
                    .LifestyleSingleton(),
                Component.For<IStudioXModuleManager, StudioXModuleManager>().ImplementedBy<StudioXModuleManager>()
                    .LifestyleSingleton(),
                Component.For<IAssemblyFinder, StudioXAssemblyFinder>().ImplementedBy<StudioXAssemblyFinder>()
                    .LifestyleSingleton(),
