...
namespace StudioX.MqMessages.Consumers
{
    public class RebusRabbitMqConsumerModule : StudioXModule
    {
        private IBus bus;
        ...
        public override void PostInitialize()
        {
            ...
            if (moduleConfig.Enabled)
            {
                ...
                bus = rebusConfig.Transport(c => c.UseRabbitMq(moduleConfig.ConnectionString, moduleConfig.QueueName))
                    .Start();
