...
namespace StudioX.IdentityFramework
{
    public static class IdentityResultExtensions
    {
            ...
            = new Dictionary<string, string>
              {
                  ...
                  {"FirstName {0} is already taken.", "Identity.DuplicateUserName"},
        ...
        public static string LocalizeErrors(this IdentityResult identityResult, ILocalizationManager localizationManager)
        {
            ...
            if (identityResult is StudioXIdentityResult)
            {
        ...
        {
            var localizationSource = localizationManager.GetSource(StudioXZeroConsts.LocalizationSourceName);
