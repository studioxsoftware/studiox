...
namespace StudioX.Authorization.Roles
{
    ...
    /// </summary>
    [Table("Roles")]
    public abstract class StudioXRoleBase : FullAuditedEntity<int>, IMayHaveTenant
    {
        /// <summary>
        ...
        protected StudioXRoleBase()
        {
            Name = Guid.NewGuid().ToString("N");
        }

        protected StudioXRoleBase(int? tenantId, string displayName)
            : this()
        {
            TenantId = tenantId;
        ...
        protected StudioXRoleBase(int? tenantId, string name, string displayName)
