...
{
    public class StudioXRoleManager<TRole, TUser> : RoleManager<TRole>, IDomainService
        ...
        where TUser : StudioXUser<TUser>
    {
        ...
        protected StudioXRoleStore<TRole, TUser> StudioXStore { get; }
        ...
        /// <param name="permissionName">FirstName of the permission</param>
