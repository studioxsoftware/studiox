...
using AutoMapper;
using StudioX.MqMessages.Handlers;

namespace StudioX.MqMessages.Mapper
{
    /// <summary>
    ...
    {
        public static void CreateEventsToMqMessagesMappings(this IMapperConfigurationExpression mapper,
            Assembly assembly)
        {
            var typesToRegister = assembly.GetTypes()
                ...
                .Where(type => type.GetTypeInfo().BaseType != null
                               ...
                               typeof(EventDataPublishHandlerBase<,>));
