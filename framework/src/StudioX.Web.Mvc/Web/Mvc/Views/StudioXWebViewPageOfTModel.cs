...
namespace StudioX.Web.Mvc.Views
{
    ...
    public abstract class StudioXWebViewPage<TModel> : WebViewPage<TModel>
    {
        /// <summary>
        ...
        {
            SingletonDependency<IStudioXAntiForgeryManager>.Instance.SetCookie(Context);
        }
    }
}
