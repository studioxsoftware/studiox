...
namespace StudioXAspNetCoreDemo.Core.Application
{
    public class ProductAppService : ApplicationService
    {
        ...
        {
            return ObjectMapper.Map<List<ProductDto>>(productRepository.GetAll().ToList());
        }
        ...
        public int CreateProduct(ProductCreateInput input)
        {
            ...
            return productRepository.InsertAndGetId(product);
        }

        public void CreateProductAndRollback(ProductCreateInput input)
        {
            productRepository.Insert(ObjectMapper.Map<Product>(input));
