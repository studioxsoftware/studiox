...
namespace StudioX.EntityFramework.Tests.Repositories
{
    public class EntityFrameworkGenericRepositoryRegistrarTests : TestBaseWithLocalIocManager
    {
        ...
        [Fact]
        public void ShouldResolveGenericRepositories()
        {
        ...
        public abstract class MyBaseDbContext : StudioXDbContext
        {
