...
using StudioX.Text.Formatting;
using Shouldly;
using Xunit;

namespace StudioX.Tests.Text.Formatting
{
    public class FormattedStringTokenizerTest
    {
        [Fact]
        public void ShouldThrowFormatExceptionForInvalidFormat()
        {
        ...
        [Fact]
        public void ShouldTokenizeForValidFormat()
        {
            TokenizeTest("");
