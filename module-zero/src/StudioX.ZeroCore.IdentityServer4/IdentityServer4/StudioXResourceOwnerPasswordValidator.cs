...
{
    public class StudioXResourceOwnerPasswordValidator<TUser> : ResourceOwnerPasswordValidator<TUser>
        where TUser : StudioXUser<TUser>
    {
        ...
        public StudioXResourceOwnerPasswordValidator(
        ...
        protected virtual IEnumerable<Claim> GetAdditionalClaimsOrNull(TUser user)
        {
            ...
            return new[] { new Claim(StudioXClaimTypes.TenantId, user.TenantId?.ToString()) };
        }
    }
}
