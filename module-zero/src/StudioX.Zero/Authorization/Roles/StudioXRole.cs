...
namespace StudioX.Authorization.Roles
{
    ...
    /// Checking 'if a user has a role' is not possible until the role is static (<see cref="StudioXRoleBase.IsStatic"/>).
    ...
    /// </remarks>
    public abstract class StudioXRole<TUser> : StudioXRoleBase, IRole<int>, IFullAudited<TUser>
        where TUser : StudioXUser<TUser>
    {
        ...
        protected StudioXRole()
        {
        }

        /// <summary>
        /// Creates a new <see cref="StudioXRole{TUser}"/> object.
        /// </summary>
        ...
        protected StudioXRole(int? tenantId, string displayName)
        ...
        /// <param name="displayName">Display name of the role</param>
        protected StudioXRole(int? tenantId, string name, string displayName)
