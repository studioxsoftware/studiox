...
using StudioX.Zero.SampleApp.Tests.TestDatas;
...
namespace StudioX.Zero.SampleApp.Tests
{
    ...
    public abstract class SampleAppTestBase<TModule> : StudioXIntegratedTestBase<TModule> 
        where TModule : StudioXModule
    {
            ...
            var user = new User
                       {
                           ...
                           FirstName = userName,
                           LastName = userName,
                           EmailAddress = userName + "@studioxsoftware.com",
